...
class DeliveryCarrier(models.Model):
    ...
    # ------------------------------------------------------------------
    enviatodo_service_type = fields.Char(
    ...
    enviatodo_api_base_url = fields.Char(
    ...
    # Datos de origen
    # ------------------------------------------------------------------
    enviatodo_origin_zip = fields.Char(
        string="CP de origen",
    ...
    def _enviatodo_check_credentials(self):
        ...
        if not self.enviatodo_api_base_url:
    ...
    def _enviatodo_request(self, endpoint, payload):
        ...
        base_url = self.enviatodo_api_base_url.rstrip("/")
        url = f"{base_url}/{endpoint.lstrip('/')}"

        headers = {
            "Content-Type": "application/json",
            "Accept": "application/json",
            "Authorization": f"Bearer {self.enviatodo_api_key}",
            "X-User-Id": str(self.enviatodo_user_id),
        }
    ...
    def _enviatodo_get_origin_zip(self):
        ...
        """
        self.ensure_one()
        origin_zip = (self.enviatodo_origin_zip or ENVIATODO_DEFAULT_ORIGIN_ZIP).strip()
    ...
    def _enviatodo_get_package_dimensions(self, record):
        ...
        length = self.enviatodo_default_length or ENVIATODO_DEFAULT_DIMENSIONS["length"]
        width = self.enviatodo_default_width or ENVIATODO_DEFAULT_DIMENSIONS["width"]
        height = self.enviatodo_default_height or ENVIATODO_DEFAULT_DIMENSIONS["height"]
        weight = self.enviatodo_default_weight or ENVIATODO_DEFAULT_DIMENSIONS["weight"]
    ...
    def _enviatodo_build_rate_payload(self, order):
        ...
        payload = {
            "api_key": self.enviatodo_api_key,
            "user_id": self.enviatodo_user_id,
            "origen": {
                "cp": origin_zip,
            },
            "destino": {
            ...
            "servicio": self.enviatodo_service_type or "express",
        }
        return payload
    ...
    def action_enviatodo_test_connection(self):
        ...
        test_payload = {
            "api_key": self.enviatodo_api_key,
            "user_id": self.enviatodo_user_id,
            "origen": {"cp": self.enviatodo_origin_zip or ENVIATODO_DEFAULT_ORIGIN_ZIP},
